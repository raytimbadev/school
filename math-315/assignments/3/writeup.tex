    ...
    \item
        \begin{enumerate}
            ...
            \item
                ...
                From these solutions, we get these equations.
                \begin{align*}
                    y_1    &=     e^x \\
                    y_2    &= x   e^x \\
                    y_3    &=     e^{-2x} \\        % HOM
                ...
                following.
                $$
                y_H = c_1 e^{-2x} + c_2 \sin{2 x} + c_3 \cos{2 x}
                $$

                We notice that components $\#3$, $\#6$, and $\#9$ from the
                big set of equations correspond to terms from the general
                solution of the complementary homogeneous equation.  The form
                of the particular solution is thus
                \begin{align*}
                    y_p &= c_1        e^x
                         + c_2    x   e^x
                         + c_4    x   e^{-2x}
            ...
            \item
                The general solution can be found by finding appropriate
                coefficients to use in the form of the particular solution.
        \end{enumerate}
